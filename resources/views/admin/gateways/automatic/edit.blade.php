                ...
                <form action="{{ route('admin.gateway.automatic.update', $gateway->code) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="payment-method-item child--item newMethodCurrency d-none">
                            <input disabled type="hidden" class="currency-symbol-input" name="currency[{{ $currencyIndex }}][symbol]"
                                   class="currencySymbol">
                            <input disabled type="hidden" class="currency-currency-input" name="currency[{{ $currencyIndex }}][currency]"
                                   class="currencyCurrency">
                            <div class="payment-method-header">
    ...
    <script>
        (function($) {
            ...
            $('.newCurrencyBtn').on('click', function() {
                ...
                var symbol = $('.newCurrencyVal').find(':selected').data('symbol') || getCurrencySelected;

                // Set currency field (hidden input for currency)
                form.find('.currency-currency-input').val(getCurrencySelected);
                
                // Set symbol field (hidden input for symbol)
                form.find('.currency-symbol-input').val(symbol);

                // Update visible currency symbols (text elements, not inputs)
                form.find('.currency--symbol').not('input').text(getCurrencySelected);
