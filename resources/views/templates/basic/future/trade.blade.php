...
@section('content')
    ...
    <div class="trading-section py-3 bg-color">
        <div class="container-fluid">
            ...
            @php
                $displayMarketData = $pair->marketData ?? optional($pair->coin)->marketData;
            @endphp
                                        ...
                                        <div class="trading-header-wrapper-left">
                                            <div class="trading-dropdown">
                                                <div class="trading-dropdown-button d-flex align-items-center">
                                                    ...
                                                    <span class="d-block trading-dropdown-button-title">{{ $pair->display_symbol ?? $pair->symbol }}</span>
                                                    <div>
                                                ...
                                                <div class="trading-dropdown-box">
                                                    ...
                                                    <div class="trading-dropdown-tabs">
                                                        <ul class="nav nav-pills mb-2  custom--tab tab-three" id="tradingCoins" role="tablist">
                                                            ...
                                                            <li class="nav-item" role="presentation">
                                                                <button class="nav-link otherListBtn" id="usdtM-tab" data-bs-toggle="pill" data-bs-target="#usdtM" type="button" role="tab" aria-controls="usdtM" aria-selected="false">@lang('USDT-M')</button>
                                                            </li>
                                                        </ul>
                                            ...
                                            <div class="trading-price">
                                                <h4 class="mb-1 market-price-{{ @$displayMarketData->id }} {{ @$pair->marketData->html_classes->price_change }}">{{ showAmount(@$displayMarketData->price, currencyFormat: false) }}</h4>
                                            </div>
                                        </div>
                                            ...
                                            <div class="trading-header selected-pair future-trading-header">
                                                <div>
                                                    ...
                                                    <p class="trading-header__number ">
                                                        <span class="market-percent-change-1h-{{ @$displayMarketData->id }} {{ @$pair->marketData->html_classes->price_change }}">{{ showAmount(@$displayMarketData->last_price, currencyFormat: false) }}</span>
                                                    </p>
                                                </div>
                                                <div>
                                ...
                                <div class="trading-asset__body">
                                    <ul class="trading-asset-info">
                                        <li class="trading-asset-info__item">
                                            <span>@lang('Overall Balance'):</span> <span>{{ showAmount($asset['wallet_balance'], currencyFormat: false) }} {{ @$pair->market->currency->symbol ?? 'USDT' }}</span>
                                        </li>
                                        <li class="trading-asset-info__item">
