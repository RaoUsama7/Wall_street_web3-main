            ...
            (function($) {
                ...
                @auth
                    ...
                    function getAvailableBalance() {
                        // Ensure currency id exists before generating the route to avoid UrlGenerationException
                        @if(isset($pair->market->currency->id) && $pair->market->currency->id)
                        ...
                        @else
                            // currency id missing — set available balance to 0 to keep UI stable
                            $('.avl-market-cur-wallet').text('0.00');
                            availableBalance = 0;
                        @endif
                    }
