...
Route::controller('FutureTradeController')->name('future.')->prefix('future')->group(function(){
    Route::get('/order/book/{symbol}', 'orderBook')->name('trade.order.book');
    Route::get('/trade/{pair?}', 'trade')->name('trade');
});
...
Route::controller('SiteController')->group(function () {
    ...
    Route::get('/us-market', 'StocksUS')->name('stocks.us');
    Route::get('/stocks/us/data','getStocksData')->name('stocks.us.data');

    Route::get('/us-market/trade/{symbol}', 'stockTradeFull')->where('symbol', '.*')->name('stocks.us.trade');
